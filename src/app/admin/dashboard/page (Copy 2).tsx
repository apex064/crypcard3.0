...
interface TopupData {
  id: number;
  user_id: string | number; // string to support alphanumeric IDs
...
interface UserData {
  id: string | number; // string to support alphanumeric IDs
  email: string;
  role: string;
  created_at: string;
}
  ...
  const createCard = async () => {
    ...
    try {
      const res = await fetch("/api/admin/cards", {
        ...
        body: JSON.stringify({
          user_id: newCardUserId, // keep string for alphanumeric IDs
