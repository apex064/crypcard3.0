...
function AppSidebar() {
  return (
    <Sidebar className="bg-gray-900 text-gray-300">
      <SidebarContent>
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-gray-400">Manage your virtual USD cards</p>
              </div>
            ...
            <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-6">
              {cards.map((card) => (
                <Card key={card.id} className="border-0 shadow-lg bg-gray-800 text-gray-100">
                  <CardContent className="p-6">
                    {/* Card Visual */}
                    <div className="p-6 bg-gradient-to-r from-blue-700 to-blue-800 rounded-lg text-white mb-6">
                      <div className="flex justify-between items-start mb-6">
                        <div>
                          <p className="text-blue-300 text-sm">{card.type}</p>
                      ...
                      <div className="flex justify-between items-end">
                        ...
                        <div className="text-right">
                          <p className="text-blue-300 text-xs">Expires</p>
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <Button
                                ...
                                className="border-gray-500 text-gray-300 hover:border-gray-400 hover:text-white"
                              >
                                {copiedCard === card.id ? (
