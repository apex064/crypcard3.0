            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <Card className="border-0 shadow-lg bg-gray-800 text-gray-100">
                <CardHeader>
                  ...
                  <CardDescription className="text-gray-400">Your active virtual USD cards</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="border-0 shadow-lg bg-gray-800 text-gray-100">
                <CardHeader>
                  ...
                  <CardDescription className="text-gray-400">Add funds using USDT TRC20</CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleTopupSubmit} className="space-y-6">
                    ...
                    <Button type="submit" className="w-full bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500">
