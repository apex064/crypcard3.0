...
import { CreditCard, Plus, ArrowUpCircle, Receipt, Copy, CheckCircle } from "lucide-react"
...
export default function UserDashboardFullScreen() {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-900 text-gray-200 p-6 flex flex-col">
      <header className="mb-8 flex justify-between items-center">
        <h1 className="text-3xl font-bold">Dashboard</h1>
      </header>

      <div className="flex-grow grid gap-8 lg:grid-cols-2">
        {/* Cards Section */}
      ...
      {/* Recent Transactions */}
      <Card className="bg-gray-800 shadow-lg mt-8 max-h-[30vh] overflow-y-auto">
        <CardHeader>
          <CardTitle className="flex items-center space-x-2">
