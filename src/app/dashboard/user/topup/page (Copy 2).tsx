        ...
        <main className="flex-1 p-6">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-400">Add funds to your virtual cards using USDT TRC20</p>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <Card className="border-0 shadow-lg bg-gray-800 text-gray-100">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">Send USDT TRC20 to top up your account</CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleTopupSubmit} className="space-y-6">
                  <div className="space-y-2">
                    <Label htmlFor="cardId" className="text-gray-300">Card ID</Label>
                  ...
                  <div className="space-y-2">
                    <Label className="text-gray-300">USDT TRC20 Wallet Address</Label>
                    <div className="flex items-center space-x-2 p-3 bg-gray-700 rounded-lg">
                      <code className="flex-1 text-sm font-mono break-all text-gray-200">{walletAddress}</code>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="txid" className="text-gray-300">Transaction ID (TXID)</Label>
                    <Input
                      id="txid"
                      value={txid}
              ...
              <CardContent>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-sm font-bold text-white">1</div>
                    <div>
                      <p className="font-medium">Enter Amount</p>
                      <p className="text-sm text-gray-400">Specify how much USD you want to add (minimum $10)</p>
                    </div>
                  </div>
                  {/* ... */}
                </div>
          ...
          <Card className="border-0 shadow-lg mt-8 bg-gray-800 text-gray-100">
            <CardHeader>
              <CardTitle>Top-up History</CardTitle>
              <CardDescription className="text-gray-400">Your recent USDT top-up transactions</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {history.length === 0 && <p className="text-sm text-gray-500">No top-ups yet.</p>}
                {history.map((h) => (
                  <div key={h.id} className="flex items-center justify-between p-4 bg-gray-700 rounded-lg">
