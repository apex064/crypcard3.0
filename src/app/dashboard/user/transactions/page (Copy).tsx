...
export default function TransactionsPage() {
  ...
  const filteredTransactions = transactions.filter(transaction =>
    ...
    transaction.card.includes(searchTerm) ||
          ...
          <div className="p-6">
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader>
                ...
                <CardDescription>All your card transactions and top-ups</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {filteredTransactions.map((transaction) => (
                    <div key={transaction.id} className="flex justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100">
                      <div className="flex space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">{transaction.date} at {transaction.time} • Card {transaction.card}</p>
